...
You can install the last version of labsimplex by downloading the [source package](https://github.com/Crparedes/labsimplex/blob/master/labsimplex.tar.gz) and installing it  with:
``` r
...
A better alternative is use `install_github()` function from `devtools` package:
``` r
